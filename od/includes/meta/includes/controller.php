	...
	public function enqueue_admin_assets( $hook ) {
		...
		if ( $hook == 'post-new.php' || $hook == 'post.php' ) {
			...
			if ( in_array( $post->post_type, $post_types ) ) {
				...
				wp_enqueue_script( 'fg-script-admin', get_template_directory_uri() . '/includes/meta/assets/scripts/fg-admin.js', [], FG_PLUGIN_VERSION );
				...
				wp_enqueue_style( 'fg-style-admin', get_template_directory_uri() . '/includes/meta/assets/stylesheets/fg-admin.css', [], FG_PLUGIN_VERSION );
