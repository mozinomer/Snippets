...
(function() {
  ...
  (function($, window, document) {
    ...
    defaults = {
      ...
      originalcontainer2Class: "ss-original-container2",
      currentcontainer2Class: "ss-current-container2",
      previouscontainer2Class: "ss-previous-container2"
    };
    Plugin = (function() {
      ...
      Plugin.prototype.errorCheck = function() {
        ...
        if (options.colWidth === null) {
          $children = this.$container2.children(options.selector);
      ...
      Plugin.prototype.createEvents = function() {
        ...
        $container2.off("ss-arrange").on("ss-arrange", function(e, trigger_drop_finished) {
          if (trigger_drop_finished == null) {
            trigger_drop_finished = false;
          }
          return _this.render(false, trigger_drop_finished);
        });
        $container2.off("ss-rearrange").on("ss-rearrange", function() {
          return _this.render(true);
        });
        $container2.off("ss-setTargetPosition").on("ss-setTargetPosition", function() {
          return _this.setTargetPosition();
        });
        $container2.off("ss-destroy").on("ss-destroy", function() {
          return _this.destroy();
        });
        return $container2.off("ss-shuffle").on("ss-shuffle", function() {
      ...
      Plugin.prototype.setIdentifier = function() {
        this.identifier = "shapeshifted_container2_" + Math.random().toString(36).substring(7);
        return this.$container2.addClass(this.identifier);
      };
      ...
      Plugin.prototype.setParsedChildren = function() {
        ...
        $children = this.$container2.find("." + this.options.activeClass).filter(":visible");
        total = $children.length;
        parsedChildren = [];
        for (i = _i = 0; 0 <= total ? _i < total : _i > total; i = 0 <= total ? ++_i : --_i) {
          $child = $($children[i]);
      ...
      Plugin.prototype.setGridColumns = function() {
        ...
        inner_width = this.$container2.innerWidth() - (padding_x * 2);
      ...
      Plugin.prototype.arrange = function(reparse, trigger_drop_finished) {
        var $child, $container2, animated, animation_speed, attributes, child_positions, container2_height, dragged_class, globals, i, is_dragged_child, max_height, min_height, options, parsed_children, placeholder_class, total_children, _i;
        if (reparse) {
          this.setParsedChildren();
        }
        globals = this.globals;
        ...
        if (trigger_drop_finished) {
          if (animated) {
            setTimeout((function() {
              return $container2.trigger("ss-drop-complete");
            }), animation_speed);
          } else {
            $container2.trigger("ss-drop-complete");
          }
        }
        $container2.trigger("ss-arranged");
        if (options.autoHeight) {
          container2_height = globals.container2_height;
          max_height = options.maxHeight;
          min_height = options.minHeight;
          if (min_height && container2_height < min_height) {
            container2_height = min_height;
          } else if (max_height && container2_height > max_height) {
            container2_height = max_height;
          }
          return $container2.height(container2_height);
        }
      };
      ...
      Plugin.prototype.getPositions = function(include_dragged) {
        ...
        if (options.autoHeight) {
          ...
          globals.container2_height = grid_height + padding_y;
        }
        return positions;
      };

      Plugin.prototype.enableDragNDrop = function() {
        var $clone, $container2, $placeholder, $selected, active_class, clone_class, current_container2_class, delete_clone, drag_clone, drag_rate, drag_timeout, dragged_class, options, original_container2_class, placeholder_class, previous_container2_class, selected_offset_x, selected_offset_y,
          _this = this;
        options = this.options;
        $container2 = this.$container2;
        ...
        dragged_class = options.draggedClass;
        placeholder_class = options.placeholderClass;
        original_container2_class = options.originalcontainer2Class;
        current_container2_class = options.currentcontainer2Class;
        previous_container2_class = options.previouscontainer2Class;
        ...
        if (options.enableDrag) {
          $container2.children("." + active_class).filter(options.dragWhitelist).draggable({
            addClasses: false,
            ...
            start: function(e, ui) {
              ...
              $selected.parent().addClass(original_container2_class).addClass(current_container2_class);
              selected_offset_y = $selected.outerHeight() / 2;
              return selected_offset_x = $selected.outerWidth() / 2;
            },
            drag: function(e, ui) {
              if (!drag_timeout && !(drag_clone && delete_clone && $("." + current_container2_class)[0] === $("." + original_container2_class)[0])) {
                $placeholder.remove().appendTo("." + current_container2_class);
                $("." + current_container2_class).trigger("ss-setTargetPosition");
                drag_timeout = true;
            ...
            stop: function() {
              var $current_container2, $original_container2, $previous_container2;
              _this.globals.dragging = false;
              $original_container2 = $("." + original_container2_class);
              $current_container2 = $("." + current_container2_class);
              $previous_container2 = $("." + previous_container2_class);
              $selected.removeClass(dragged_class);
              $("." + placeholder_class).remove();
              if (drag_clone) {
                if (delete_clone && $("." + current_container2_class)[0] === $("." + original_container2_class)[0]) {
                  $clone.remove();
                  $("." + current_container2_class).trigger("ss-rearrange");
                } else {
                    $clone.removeClass(clone_class);
                    $original_container2.shapeshift($original_container2.data("plugin_shapeshift").options);
                    $current_container2.shapeshift($current_container2.data("plugin_shapeshift").options);
                }
              }
              if ($original_container2[0] === $current_container2[0]) {
                $current_container2.trigger("ss-rearranged", $selected);
              } else {
                $original_container2.trigger("ss-removed", $selected);
                $current_container2.trigger("ss-added", $selected);
              }
              $original_container2.trigger("ss-arrange").removeClass(original_container2_class);
              $current_container2.trigger("ss-arrange", true).removeClass(current_container2_class);
              $previous_container2.trigger("ss-arrange").removeClass(previous_container2_class);
              return $selected = $placeholder = null;
            }
          });
        }
        if (options.enableCrossDrop) {
          return $container2.droppable({
            accept: options.crossDropWhitelist,
            tolerance: 'intersect',
            over: function(e) {
              $("." + previous_container2_class).removeClass(previous_container2_class);
              $("." + current_container2_class).removeClass(current_container2_class).addClass(previous_container2_class);
              return $(e.target).addClass(current_container2_class);
            },
            drop: function(e, selected) {
              ...
              if (_this.options.enableTrash) {
                ...
                $current_container2.trigger("ss-trashed", $selected);
                $selected.remove();
                $original_container2.trigger("ss-rearrange").removeClass(original_container2_class);
                $current_container2.trigger("ss-rearrange").removeClass(current_container2_class);
                return $previous_container2.trigger("ss-arrange").removeClass(previous_container2_class);
              }
            }
          });
        }
      ...
      Plugin.prototype.setTargetPosition = function() {
        var $selected, $start_container2, $target, attributes, child_positions, cutoff_end, cutoff_start, distance, dragged_class, options, parsed_children, placeholder_class, position_i, previous_container2_class, selected_x, selected_y, shortest_distance, target_position, total_positions, x_dist, y_dist, _i;
        options = this.options;
        if (!options.enableTrash) {
          dragged_class = options.draggedClass;
          $selected = $("." + dragged_class);
          $start_container2 = $selected.parent();
          parsed_children = this.parsedChildren;
          child_positions = this.getPositions(false);
          total_positions = child_positions.length;
          selected_x = $selected.offset().left - $start_container2.offset().left + (this.globals.col_width / 2);
          selected_y = $selected.offset().top - $start_container2.offset().top + ($selected.height() / 2);
          ...
          if (total_positions > 1) {
            ...
            if (total_positions === 1) {
              ...
              if (attributes.left < selected_x) {
                this.$container2.append($selected);
              } else {
                this.$container2.prepend($selected);
              }
            } else {
              this.$container2.append($selected);
            }
          ...
          this.arrange(true);
          if ($start_container2[0] !== $selected.parent()[0]) {
              previous_container2_class = options.previouscontainer2Class;
              if ($("." + previous_container2_class).data("plugin_shapeshift").options.enableCrossDrop == true) {
                  return $("." + previous_container2_class).trigger("ss-rearrange");
              } else {
                  return $("." + previous_container2_class);
              }
          }
        } else {
      ...
      Plugin.prototype.shuffle = function() {
        ...
        calculateShuffled = function(container2, activeClass) {
          var shuffle;
          ...
          return container2.each(function() {
            var items;
            items = container2.find("." + activeClass).filter(":visible");
            if (items.length) {
              return container2.html(shuffle(items));
            } else {
              return this;
            }
          });
        ...
        if (!this.globals.dragging) {
          calculateShuffled(this.$container2, this.options.activeClass);
          this.enableFeatures();
          return this.$container2.trigger("ss-rearrange");
        }
      };
      ...
      Plugin.prototype.destroy = function() {
        var $active_children, $container2, active_class;
        $container2 = this.$container2;
        $container2.off("ss-arrange");
        $container2.off("ss-rearrange");
        $container2.off("ss-setTargetPosition");
        $container2.off("ss-destroy");
        active_class = this.options.activeClass;
        $active_children = $container2.find("." + active_class);
        if (this.options.enableDrag) {
          $active_children.draggable('destroy');
        }
        if (this.options.enableCrossDrop) {
          $container2.droppable('destroy');
        }
        $active_children.removeClass(active_class);
        return $container2.removeClass(this.identifier);
      };
    ...
    return $.fn[pluginName] = function(options) {
      return this.each(function() {
        ...
        old_class = (_ref = $(this).attr("class")) != null ? (_ref1 = _ref.match(/shapeshifted_container2_\w+/)) != null ? _ref1[0] : void 0 : void 0;
        if (old_class) {
