...
<div class="container">
	...
	<div class="row">
		<div class="col-md-9">
			<?php $data_query =  new WP_Query(array('post_type' => 'post', 'order_by','Des', 'post_per_page' => '1'));?>
				<?php while ( $data_query->have_posts() ) : $data_query->the_post();?>
					<div class="row">
						...
						<div class="col-md-10 right_block_post_blog">
							<div class="row title_blog_post">
								<?php the_title();?>
							</div>
							<div class="the_thumbnail_blog_post">
								<?php the_post_thumbnail();?>
							</div>
							<div class="row exceprt_blog_post">
								<div class="container">
									<?php the_excerpt();?>
								</div>
								<div class="container read_more_link_blog_post">
